...
public class Eingabe {
	...
	// Ein Feld das die "Merrems" dieser Welt als String aufnimmt
	String entscheid, eingabe;
	Scanner keyboard=new Scanner(System.in);
	System.out.println("Bitte geben Sie den Meerem Namen ein ");
	String eingabe = keyboard.nextLine();    
       boolean fertig = false;
    while (!fertig) {
    // Zuerst ein Bildschirmmenue
    System.out.println("Geben Sie die zu invertierenden Buchstabenfolgen ein");
